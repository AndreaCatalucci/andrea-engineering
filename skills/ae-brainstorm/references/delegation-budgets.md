...
Read this only when dispatching the conditional Deep grounding scout, claim verifier, or opt-in Slack researcher. Use the inherited model; control cost with evidence and output budgets:

- **Deep grounding scout:** about 20 targeted reads; dossier at most 150 lines; return a 3-5 line gist and path.
