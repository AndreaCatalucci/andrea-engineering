...
> Diff-scoped browser QA of `<branch>` vs the trunk. Generated by `$ae-dogfood` on <YYYY-MM-DD>.
...
<Reusable lessons worth carrying forward — patterns, gotchas, product/UX insights. Feed substantial ones to `ae-compound`.>
