...
$ae-test-xcode MyApp-Debug

# Test after making changes
$ae-test-xcode current
```

## Integration with ae-code-review

When reviewing PRs that touch iOS code, the `ae-code-review` workflow can spawn an agent to run this skill, build on the simulator, test key screens, and check for crashes.
