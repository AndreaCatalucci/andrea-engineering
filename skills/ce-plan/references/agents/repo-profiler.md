...
- **Conventions & instruction files** — paths and a short digest of root `AGENTS.md`, `ARCHITECTURE.md`, `README.md`, `CONTRIBUTING.md`, and `STRATEGY.md`: coding standards, testing conventions, review process, and product direction. Keep subdirectory-scoped instructions fresh rather than caching them.
