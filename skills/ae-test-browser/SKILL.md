...
```text
Run $ae-test-browser for the current branch.
Run $ae-test-browser for PR 847.
Run $ae-test-browser for branch feature/new-dashboard.
Run $ae-test-browser for the current branch on port 5000.
```
