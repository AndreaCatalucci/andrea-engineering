...
```bash
$ae-promote                                   # Derive what shipped from context, draft defaults
$ae-promote [free-form description]           # You describe what shipped
$ae-promote a tweet thread and a LinkedIn post   # Request specific channels
$ae-promote 3 tweet options for the new export feature
```
...
> User: `$ae-promote 3 tweet options for the new one-click CSV export`
...
> User: `$ae-promote draft a launch across X, LinkedIn, and email`
