...
When offering, use the shared codex-interaction contract described above. If the user accepts, run `$ce-compound`, then commit the resulting learning doc to the same branch and push so the open PR picks up the new commit.
