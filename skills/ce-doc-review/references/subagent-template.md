...
This template is used by the ce-doc-review orchestrator to spawn each reviewer subagent. Variable substitution slots are filled at dispatch time.
...
- You are a leaf reviewer inside an already-running andrea-engineering review workflow. Do not invoke andrea-engineering skills or agents unless this template explicitly instructs you to. Perform your analysis directly and return findings in the required output format only.
