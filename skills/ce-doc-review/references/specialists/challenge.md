...
Pressure-test whether the requirements choose the right problem, outcome, and scope. Construct counterarguments rather than compiling generic questions.

## Check

- **Premise:** Could every requirement ship while the stated problem remains unsolved?
- **Assumptions:** Which user, environmental, scale, or sequencing condition must hold? What concrete outcome follows if it does not?
...
Retain a finding only when its counterexample is concrete enough to change a requirement, priority, or explicit decision.
