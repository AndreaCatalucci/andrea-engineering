---
name: ae-challenge
description: Challenge a candidate solution. Use when an idea exists and needs to be stress-tested against the current product.
---

# Challenge

The user has a candidate solution. Challenge whether it holds.

Read the request and relevant project context. Bring discoverable facts into the conversation.

Treat the candidate as a hypothesis. Sketch rival prototypes only as pressure on it.
